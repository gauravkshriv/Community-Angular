...
declare var $ :any;
@Component({
  selector: 'app-landdeveloper',
  templateUrl: './landdeveloper.component.html',
  styleUrls: ['./landdeveloper.component.css']
})
export class LanddeveloperComponent implements OnInit {
  data:any;
  userlist=[];
    statenam:any;
    objectKeys: any
  ...
  // public _loading: boolean = false;
   ...
   loadData(page){
    ...
    this.occupation = "LAND_DEVELOPER";
    this.location = "India";
    this.page = page;
    this.size= 10;
    this.rating = "0-5";
    ...
    this.questionservice.getFilter(this.occupation,this.location,this.rating,this.page,this.size)
       ...
       (data) =>  {
        ...
        console.log("loading----->",this.filterdata);
