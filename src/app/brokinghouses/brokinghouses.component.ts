...
@Component({
  selector: 'app-brokinghouses',
  templateUrl: './brokinghouses.component.html',
  styleUrls: ['./brokinghouses.component.css']
})
export class BrokinghousesComponent implements OnInit {
  data:any;
  userlist=[];
    statenam:any;
    objectKeys: any
